...
class SozlukContent(models.Model):
    ...
    plural_wort_status = models.CharField(
        max_length=50, verbose_name="plural_wort_status")
    ...
    referans_video = models.CharField(
        max_length=500, verbose_name="referans_video")
    ...
    ekleyenId = models.ManyToManyField(User)
    ...
    anmerkungen_de = models.CharField(
        max_length=500, verbose_name="anmerkungen_de")
    anmerkungen_tr = models.CharField(
        max_length=500, verbose_name="anmerkungen_tr")
